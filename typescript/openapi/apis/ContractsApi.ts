...
export class ContractsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param integrationId 
     */
    public async getContractByIntegrationId(integrationType: IntegrationType, integrationId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param customerId 
     */
    public async listContracts(limit?: number, cursor?: string, customerId?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
