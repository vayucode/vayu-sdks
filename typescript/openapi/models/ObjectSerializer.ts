...
import { ConflictErrorResponse, ConflictErrorResponseTypeEnum  , ConflictErrorResponseCodeEnum    } from '../models/ConflictErrorResponse';
...
import { NotFoundErrorResponse, NotFoundErrorResponseTypeEnum  , NotFoundErrorResponseCodeEnum    } from '../models/NotFoundErrorResponse';
...
import { ProductGroupProductsInnerPricingOneOf5, ProductGroupProductsInnerPricingOneOf5TypeEnum     } from '../models/ProductGroupProductsInnerPricingOneOf5';
import { ProductGroupProductsInnerPricingOneOf6, ProductGroupProductsInnerPricingOneOf6TypeEnum     } from '../models/ProductGroupProductsInnerPricingOneOf6';
import { ProductGroupProductsInnerPricingOneOfDiscount , ProductGroupProductsInnerPricingOneOfDiscountTypeEnum     } from '../models/ProductGroupProductsInnerPricingOneOfDiscount';
...
import { V2QueryEventsAggregationRequest    , V2QueryEventsAggregationRequestGroupByEnum    } from '../models/V2QueryEventsAggregationRequest';
...
import { V2QueryEventsAggregationRequestMetersInnerAggregationFieldArithmetic, V2QueryEventsAggregationRequestMetersInnerAggregationFieldArithmeticOperatorEnum    } from '../models/V2QueryEventsAggregationRequestMetersInnerAggregationFieldArithmetic';
import { V2QueryEventsAggregationRequestMetersInnerFiltersInner , V2QueryEventsAggregationRequestMetersInnerFiltersInnerOperatorEnum    } from '../models/V2QueryEventsAggregationRequestMetersInnerFiltersInner';
...
import { V2QueryEventsAggregationResponse  , V2QueryEventsAggregationResponseGroupByEnum   } from '../models/V2QueryEventsAggregationResponse';
...
let enumsMap: Set<string> = new Set<string>([
    ...
    "ConflictErrorResponseTypeEnum",
    "ConflictErrorResponseCodeEnum",
    "ContractStatus",
    "CreateCustomFieldRequestIntegrationSourceEnum",
    ...
    "NotFoundErrorResponseTypeEnum",
    "NotFoundErrorResponseCodeEnum",
    ...
    "ProductGroupProductsInnerPricingOneOf5TypeEnum",
    "ProductGroupProductsInnerPricingOneOf6TypeEnum",
    "ProductGroupProductsInnerPricingOneOfDiscountTypeEnum",
    "ProductGroupProductsInnerSchedulingDurationUnitEnum",
    "RateLimitErrorResponseTypeEnum",
    "RateLimitErrorResponseCodeEnum",
    "RequestTooLongErrorResponseTypeEnum",
    "RequestTooLongErrorResponseCodeEnum",
    "SyncStatus",
    "UnauthorizedErrorResponseTypeEnum",
    "UnauthorizedErrorResponseCodeEnum",
    "UnlimitedDuration",
    "UpdateCustomFieldRequestIntegrationSourceEnum",
    "UpdateCustomerRequestDueDaysEnum",
    "V2QueryEventsAggregationRequestGroupByEnum",
    "V2QueryEventsAggregationRequestMetersInnerAggregationFieldArithmeticOperatorEnum",
    "V2QueryEventsAggregationRequestMetersInnerFiltersInnerOperatorEnum",
    "V2QueryEventsAggregationResponseGroupByEnum",
...
let typeMap: {[index: string]: any} = {
    ...
    "CreateCustomFieldResponseCustomField": CreateCustomFieldResponseCustomField,
    ...
    "DeleteCustomFieldResponseCustomField": DeleteCustomFieldResponseCustomField,
    ...
    "ProductGroupProductsInnerCommitmentSchedulingDuration": ProductGroupProductsInnerCommitmentSchedulingDuration,
    ...
    "ProductGroupProductsInnerPricingOneOfDiscount": ProductGroupProductsInnerPricingOneOfDiscount,
    ...
    "V2DeleteEventResponse": V2DeleteEventResponse,
    "V2DeleteEventsByRefsRequest": V2DeleteEventsByRefsRequest,
    "V2DeleteEventsByRefsResponse": V2DeleteEventsByRefsResponse,
    "V2EventsDryRunRequest": V2EventsDryRunRequest,
    "V2EventsDryRunResponse": V2EventsDryRunResponse,
    "V2GetEventResponse": V2GetEventResponse,
    "V2QueryEventsAggregationRequest": V2QueryEventsAggregationRequest,
    "V2QueryEventsAggregationRequestMetersInner": V2QueryEventsAggregationRequestMetersInner,
    "V2QueryEventsAggregationRequestMetersInnerAggregation": V2QueryEventsAggregationRequestMetersInnerAggregation,
    "V2QueryEventsAggregationRequestMetersInnerAggregationFieldArithmetic": V2QueryEventsAggregationRequestMetersInnerAggregationFieldArithmetic,
    "V2QueryEventsAggregationRequestMetersInnerFiltersInner": V2QueryEventsAggregationRequestMetersInnerFiltersInner,
    "V2QueryEventsAggregationRequestMetersInnerFiltersInnerValue": V2QueryEventsAggregationRequestMetersInnerFiltersInnerValue,
    "V2QueryEventsAggregationRequestMetersInnerSqlFullQuery": V2QueryEventsAggregationRequestMetersInnerSqlFullQuery,
    "V2QueryEventsAggregationRequestPeriod": V2QueryEventsAggregationRequestPeriod,
    "V2QueryEventsAggregationResponse": V2QueryEventsAggregationResponse,
    "V2QueryEventsAggregationResponseDataPointsInner": V2QueryEventsAggregationResponseDataPointsInner,
    "V2QueryEventsResponse": V2QueryEventsResponse,
    "V2SendEventsRequest": V2SendEventsRequest,
    "V2SendEventsResponse": V2SendEventsResponse,
    "ValidationErrorResponse": ValidationErrorResponse,
    "ValidationErrorResponseParamsInner": ValidationErrorResponseParamsInner,
