...
export class ListCatalogProductsResponse {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "baseName": "catalogProducts",
            "type": "Array<CreateCatalogProductResponseCatalogProduct>",
            "format": ""
        },
        {
            "name": "total",
    ...
    static getAttributeTypeMap() {
        return ListCatalogProductsResponse.attributeTypeMap;
    }
