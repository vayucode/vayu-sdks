...
// checks if the DeleteEventsByRefsResponseEventsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteEventsByRefsResponseEventsInner{}

// DeleteEventsByRefsResponseEventsInner struct for DeleteEventsByRefsResponseEventsInner
type DeleteEventsByRefsResponseEventsInner struct {
...
type _DeleteEventsByRefsResponseEventsInner DeleteEventsByRefsResponseEventsInner
...
func NewDeleteEventsByRefsResponseEventsInner(name string, timestamp time.Time, customerAlias string, ref string, id string, createdAt time.Time, updatedAt time.Time, deletedAt string) *DeleteEventsByRefsResponseEventsInner {
	this := DeleteEventsByRefsResponseEventsInner{}
	this.Name = name
...
func (o DeleteEventsByRefsResponseEventsInner) MarshalJSON() ([]byte, error) {
...
func (o DeleteEventsByRefsResponseEventsInner) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteEventsByRefsResponseEventsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteEventsByRefsResponseEventsInner := _DeleteEventsByRefsResponseEventsInner{}

	err = json.Unmarshal(data, &varDeleteEventsByRefsResponseEventsInner)

	if err != nil {
		return err
	}

	*o = DeleteEventsByRefsResponseEventsInner(varDeleteEventsByRefsResponseEventsInner)
...
type NullableDeleteEventsByRefsResponseEventsInner struct {
	value *DeleteEventsByRefsResponseEventsInner
	isSet bool
}

func (v NullableDeleteEventsByRefsResponseEventsInner) Get() *DeleteEventsByRefsResponseEventsInner {
	return v.value
}

func (v *NullableDeleteEventsByRefsResponseEventsInner) Set(val *DeleteEventsByRefsResponseEventsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteEventsByRefsResponseEventsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteEventsByRefsResponseEventsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteEventsByRefsResponseEventsInner(val *DeleteEventsByRefsResponseEventsInner) *NullableDeleteEventsByRefsResponseEventsInner {
	return &NullableDeleteEventsByRefsResponseEventsInner{value: val, isSet: true}
}

func (v NullableDeleteEventsByRefsResponseEventsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteEventsByRefsResponseEventsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
