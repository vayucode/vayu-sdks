...
/*
CreditTopUp Create a one-off invoice to top up a customer with credits

This endpoint creates a one-off invoice that bills a customer for a credit grant.
...
*/
func (a *CreditsAPIService) CreditTopUp(ctx context.Context) ApiCreditTopUpRequest {
	return ApiCreditTopUpRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CreditsAPIService) CreditTopUpExecute(r ApiCreditTopUpRequest) (*CreditTopUpResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CreditsAPIService.CreditTopUp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/credits/top-up"
