...
// checks if the GetProductConsumptionResponseProductConsumption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetProductConsumptionResponseProductConsumption{}

// GetProductConsumptionResponseProductConsumption struct for GetProductConsumptionResponseProductConsumption
type GetProductConsumptionResponseProductConsumption struct {
...
type _GetProductConsumptionResponseProductConsumption GetProductConsumptionResponseProductConsumption
...
func NewGetProductConsumptionResponseProductConsumption(productId string, productName string, provisionedAmount float32, consumedAmount float32, usagePercentage float32, hasAccess bool) *GetProductConsumptionResponseProductConsumption {
	this := GetProductConsumptionResponseProductConsumption{}
...
func (o GetProductConsumptionResponseProductConsumption) MarshalJSON() ([]byte, error) {
...
func (o GetProductConsumptionResponseProductConsumption) ToMap() (map[string]interface{}, error) {
...
func (o *GetProductConsumptionResponseProductConsumption) UnmarshalJSON(data []byte) (err error) {
	...
	varGetProductConsumptionResponseProductConsumption := _GetProductConsumptionResponseProductConsumption{}

	err = json.Unmarshal(data, &varGetProductConsumptionResponseProductConsumption)

	if err != nil {
		return err
	}

	*o = GetProductConsumptionResponseProductConsumption(varGetProductConsumptionResponseProductConsumption)
...
type NullableGetProductConsumptionResponseProductConsumption struct {
	value *GetProductConsumptionResponseProductConsumption
	isSet bool
}

func (v NullableGetProductConsumptionResponseProductConsumption) Get() *GetProductConsumptionResponseProductConsumption {
	return v.value
}

func (v *NullableGetProductConsumptionResponseProductConsumption) Set(val *GetProductConsumptionResponseProductConsumption) {
	v.value = val
	v.isSet = true
}

func (v NullableGetProductConsumptionResponseProductConsumption) IsSet() bool {
	return v.isSet
}

func (v *NullableGetProductConsumptionResponseProductConsumption) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetProductConsumptionResponseProductConsumption(val *GetProductConsumptionResponseProductConsumption) *NullableGetProductConsumptionResponseProductConsumption {
	return &NullableGetProductConsumptionResponseProductConsumption{value: val, isSet: true}
}

func (v NullableGetProductConsumptionResponseProductConsumption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetProductConsumptionResponseProductConsumption) UnmarshalJSON(src []byte) error {
	v.isSet = true
