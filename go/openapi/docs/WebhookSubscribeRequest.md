...
**RecurringThreshold** | Pointer to **float32** |  | [optional] 
...
### GetRecurringThreshold

`func (o *WebhookSubscribeRequest) GetRecurringThreshold() float32`

GetRecurringThreshold returns the RecurringThreshold field if non-nil, zero value otherwise.

### GetRecurringThresholdOk

`func (o *WebhookSubscribeRequest) GetRecurringThresholdOk() (*float32, bool)`

GetRecurringThresholdOk returns a tuple with the RecurringThreshold field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetRecurringThreshold sets RecurringThreshold field to given value.
