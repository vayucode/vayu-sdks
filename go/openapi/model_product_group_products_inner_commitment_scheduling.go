...
type _ProductGroupProductsInnerCommitmentScheduling ProductGroupProductsInnerCommitmentScheduling
...
func (o ProductGroupProductsInnerCommitmentScheduling) MarshalJSON() ([]byte, error) {
...
func (o ProductGroupProductsInnerCommitmentScheduling) ToMap() (map[string]interface{}, error) {
...
func (o *ProductGroupProductsInnerCommitmentScheduling) UnmarshalJSON(data []byte) (err error) {
	...
	varProductGroupProductsInnerCommitmentScheduling := _ProductGroupProductsInnerCommitmentScheduling{}

	err = json.Unmarshal(data, &varProductGroupProductsInnerCommitmentScheduling)

	if err != nil {
		return err
	}

	*o = ProductGroupProductsInnerCommitmentScheduling(varProductGroupProductsInnerCommitmentScheduling)
...
type NullableProductGroupProductsInnerCommitmentScheduling struct {
	value *ProductGroupProductsInnerCommitmentScheduling
	isSet bool
}

func (v NullableProductGroupProductsInnerCommitmentScheduling) Get() *ProductGroupProductsInnerCommitmentScheduling {
	return v.value
}

func (v *NullableProductGroupProductsInnerCommitmentScheduling) Set(val *ProductGroupProductsInnerCommitmentScheduling) {
	v.value = val
	v.isSet = true
}

func (v NullableProductGroupProductsInnerCommitmentScheduling) IsSet() bool {
	return v.isSet
}

func (v *NullableProductGroupProductsInnerCommitmentScheduling) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductGroupProductsInnerCommitmentScheduling(val *ProductGroupProductsInnerCommitmentScheduling) *NullableProductGroupProductsInnerCommitmentScheduling {
	return &NullableProductGroupProductsInnerCommitmentScheduling{value: val, isSet: true}
}

func (v NullableProductGroupProductsInnerCommitmentScheduling) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductGroupProductsInnerCommitmentScheduling) UnmarshalJSON(src []byte) error {
	v.isSet = true
