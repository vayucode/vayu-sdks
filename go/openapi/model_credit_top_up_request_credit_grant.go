...
// checks if the CreditTopUpRequestCreditGrant type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreditTopUpRequestCreditGrant{}

// CreditTopUpRequestCreditGrant struct for CreditTopUpRequestCreditGrant
type CreditTopUpRequestCreditGrant struct {
...
type _CreditTopUpRequestCreditGrant CreditTopUpRequestCreditGrant
...
func NewCreditTopUpRequestCreditGrant(name string, creditProductId string, balanceKind string, grantAmount float32, schedule string) *CreditTopUpRequestCreditGrant {
	this := CreditTopUpRequestCreditGrant{}
	this.Name = name
...
func (o *CreditTopUpRequestCreditGrant) SetPriceNil() {
	o.Price.Set(nil)
}
...
func (o *CreditTopUpRequestCreditGrant) SetExpirationDateNil() {
...
func (o CreditTopUpRequestCreditGrant) MarshalJSON() ([]byte, error) {
...
func (o CreditTopUpRequestCreditGrant) ToMap() (map[string]interface{}, error) {
...
func (o *CreditTopUpRequestCreditGrant) UnmarshalJSON(data []byte) (err error) {
	...
	varCreditTopUpRequestCreditGrant := _CreditTopUpRequestCreditGrant{}

	err = json.Unmarshal(data, &varCreditTopUpRequestCreditGrant)

	if err != nil {
		return err
	}

	*o = CreditTopUpRequestCreditGrant(varCreditTopUpRequestCreditGrant)
...
type NullableCreditTopUpRequestCreditGrant struct {
	value *CreditTopUpRequestCreditGrant
	isSet bool
}

func (v NullableCreditTopUpRequestCreditGrant) Get() *CreditTopUpRequestCreditGrant {
	return v.value
}

func (v *NullableCreditTopUpRequestCreditGrant) Set(val *CreditTopUpRequestCreditGrant) {
	v.value = val
	v.isSet = true
}

func (v NullableCreditTopUpRequestCreditGrant) IsSet() bool {
	return v.isSet
}

func (v *NullableCreditTopUpRequestCreditGrant) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreditTopUpRequestCreditGrant(val *CreditTopUpRequestCreditGrant) *NullableCreditTopUpRequestCreditGrant {
	return &NullableCreditTopUpRequestCreditGrant{value: val, isSet: true}
}

func (v NullableCreditTopUpRequestCreditGrant) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreditTopUpRequestCreditGrant) UnmarshalJSON(src []byte) error {
	v.isSet = true
