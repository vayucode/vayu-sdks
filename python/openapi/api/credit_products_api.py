...
class CreditProductsApi:
    ...
    def list_credit_products(
        ...
        _param = self._list_credit_products_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListCreditProductsResponse",
    ...
    @validate_call
    def list_credit_products_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListCreditProductsResponse]:
        """List credit products
    ...
    @validate_call
    def list_credit_products_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_credit_products_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
