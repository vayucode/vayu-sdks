...
class ContractsApi:
    ...
    def get_contract_by_integration_id(
        ...
        _param = self._get_contract_by_integration_id_serialize(
    ...
    def get_contract_by_integration_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetContractByIntegrationIdResponse]:
        """Get contract by integration id
    ...
    def _get_contract_by_integration_id_serialize(
        self,
        integration_type,
        integration_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/contracts/integration/{integrationType}/{integrationId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
