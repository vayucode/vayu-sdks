...
class ProductConsumptionsApi:
    ...
    def get_product_consumption(
        ...
        _param = self._get_product_consumption_serialize(
    ...
    @validate_call
    def get_product_consumption_with_http_info(
        self,
        product_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetProductConsumptionResponse]:
        """Get product consumption
    ...
    @validate_call
    def get_product_consumption_without_preload_content(
        self,
        product_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_product_consumption_serialize(
        self,
        product_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/product-consumption/{productId}',
