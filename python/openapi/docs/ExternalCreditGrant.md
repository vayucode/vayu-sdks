...
json = "{}"
# create an instance of ExternalCreditGrant from a JSON string
external_credit_grant_instance = ExternalCreditGrant.from_json(json)
# print the JSON string representation of the object
print(ExternalCreditGrant.to_json())

# convert the object into a dict
external_credit_grant_dict = external_credit_grant_instance.to_dict()
# create an instance of ExternalCreditGrant from a dict
external_credit_grant_from_dict = ExternalCreditGrant.from_dict(external_credit_grant_dict)
```
