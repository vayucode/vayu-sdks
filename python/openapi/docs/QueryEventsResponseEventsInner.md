...
query_events_response_events_inner_instance = QueryEventsResponseEventsInner.from_json(json)
# print the JSON string representation of the object
print(QueryEventsResponseEventsInner.to_json())

# convert the object into a dict
query_events_response_events_inner_dict = query_events_response_events_inner_instance.to_dict()
# create an instance of QueryEventsResponseEventsInner from a dict
query_events_response_events_inner_from_dict = QueryEventsResponseEventsInner.from_dict(query_events_response_events_inner_dict)
```
