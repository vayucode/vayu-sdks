...
class LoginRequest(BaseModel):
    ...
    LoginRequest
    """ # noqa: E501
    refresh_token: StrictStr = Field(description="The refresh token issued for the authentication process. It is required to obtain a new access token.", alias="refreshToken")
