...
class GetProductConsumptionResponse(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of product_consumption
        if self.product_consumption:
            _dict['productConsumption'] = self.product_consumption.to_dict()
