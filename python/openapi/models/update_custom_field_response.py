...
class UpdateCustomFieldResponse(BaseModel):
    """
    UpdateCustomFieldResponse
    """ # noqa: E501
    custom_field: CreateCustomFieldResponseCustomField = Field(alias="customField")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customField": CreateCustomFieldResponseCustomField.from_dict(obj["customField"]) if obj.get("customField") is not None else None
        })
