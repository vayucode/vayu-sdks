...
class DeleteEventsByRefsResponseEventsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "timestamp", "customerAlias", "ref", "data", "id", "createdAt", "updatedAt", "deletedAt"]
