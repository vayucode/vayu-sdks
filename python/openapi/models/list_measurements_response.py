...
class ListMeasurementsResponse(BaseModel):
    ...
    """ # noqa: E501
    measurements: List[CreateMeasurementResponseMeasurement]
    ...
    __properties: ClassVar[List[str]] = ["measurements", "total", "hasMore", "nextCursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "measurements": [CreateMeasurementResponseMeasurement.from_dict(_item) for _item in obj["measurements"]] if obj.get("measurements") is not None else None,
            "total": obj.get("total"),
