...
class ListCustomersResponse(BaseModel):
    ...
    """ # noqa: E501
    customers: List[CreateCustomerResponseCustomer]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customers": [CreateCustomerResponseCustomer.from_dict(_item) for _item in obj["customers"]] if obj.get("customers") is not None else None,
            "total": obj.get("total"),
