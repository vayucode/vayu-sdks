...
class GetContractByIntegrationIdResponse(BaseModel):
    """
    GetContractByIntegrationIdResponse
    """ # noqa: E501
    contract: Optional[GetContractResponseContract] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contract": GetContractResponseContract.from_dict(obj["contract"]) if obj.get("contract") is not None else None
        })
