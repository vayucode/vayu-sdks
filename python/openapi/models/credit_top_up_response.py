...
class CreditTopUpResponse(BaseModel):
    ...
    CreditTopUpResponse
    """ # noqa: E501
    invoice_id: Annotated[str, Field(strict=True)] = Field(description="The ID of the one-off invoice created for the credit top-up.", alias="invoiceId")
    customer_id: Annotated[str, Field(strict=True)] = Field(description="The ID of the customer the invoice was created for.", alias="customerId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["invoiceId", "customerId"]
