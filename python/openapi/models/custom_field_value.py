...
class CustomFieldValue(BaseModel):
    ...
    CustomFieldValue
    """ # noqa: E501
    custom_field_definition_id: StrictStr = Field(alias="customFieldDefinitionId")
    value: Optional[StrictStr] = None
    field_name: Optional[StrictStr] = Field(default=None, alias="fieldName")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["customFieldDefinitionId", "value", "fieldName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customFieldDefinitionId": obj.get("customFieldDefinitionId"),
            "value": obj.get("value"),
