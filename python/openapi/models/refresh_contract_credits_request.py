...
class RefreshContractCreditsRequest(BaseModel):
    """
    RefreshContractCreditsRequest
    """ # noqa: E501
    grants: Optional[List[RefreshContractCreditsRequestGrantsInner]] = Field(default=None, description="The credit grants to refresh. Each refreshed grant is set to non-prorated (and optionally re-priced), while every other credit grant on the contract is set to prorated. If omitted, all credit grants on the contract are refreshed (set to non-prorated) and none are prorated.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "grants": [RefreshContractCreditsRequestGrantsInner.from_dict(_item) for _item in obj["grants"]] if obj.get("grants") is not None else None
        })
