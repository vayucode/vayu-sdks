...
class AcknowledgedEvent(BaseModel):
    """
    AcknowledgedEvent
    """ # noqa: E501
    ...
    data: Optional[Dict[str, Optional[Dict[str, Any]]]] = Field(default=None, description="A schema-less JSON object encapsulating miscellaneous attributes and metrics associated with the event.")
    ack_id: StrictStr = Field(description="Per-event acknowledgment ID confirming Vayu received this event. Use it to demonstrate the event was sent to Vayu.", alias="ackId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "timestamp", "customerAlias", "ref", "data", "ackId"]
