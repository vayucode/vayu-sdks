...
class UsageWindow(BaseModel):
    ...
    """ # noqa: E501
    start: datetime = Field(description="The start timestamp of the usage window in ISO 8601 format")
    end: datetime = Field(description="The end timestamp of the usage window in ISO 8601 format")
