...
class RefreshContractCreditsResponse(BaseModel):
    """
    RefreshContractCreditsResponse
    """ # noqa: E501
    contract_id: Annotated[str, Field(strict=True)] = Field(description="The identifier of the contract whose credit grants were refreshed", alias="contractId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["contractId"]
