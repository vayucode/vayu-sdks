...
class GetMeasurementResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "measurement": CreateMeasurementResponseMeasurement.from_dict(obj["measurement"]) if obj.get("measurement") is not None else None
        })
