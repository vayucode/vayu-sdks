...
class V2EventsDryRunResponse(BaseModel):
    """
    V2EventsDryRunResponse
    """ # noqa: E501
    events: List[EventsDryRunResponseObject]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [EventsDryRunResponseObject.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
