...
class InvoicePaymentStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    invoice_id: Annotated[str, Field(strict=True)] = Field(alias="invoiceId")
    ...
    __properties: ClassVar[List[str]] = ["invoiceId", "billingStatus", "amountDue", "amountPaid", "total", "dueDate", "paidAt", "invoicePdfUrl"]
