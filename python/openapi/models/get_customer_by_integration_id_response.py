...
class GetCustomerByIntegrationIdResponse(BaseModel):
    """
    GetCustomerByIntegrationIdResponse
    """ # noqa: E501
    customer: Optional[CreateCustomerResponseCustomer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customer": CreateCustomerResponseCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None
        })
