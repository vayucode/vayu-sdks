...
class GetCustomerByNameResponse(BaseModel):
    """
    GetCustomerByNameResponse
    """ # noqa: E501
    customer: GetCustomerByNameResponseCustomer
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customer": GetCustomerByNameResponseCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None
        })
