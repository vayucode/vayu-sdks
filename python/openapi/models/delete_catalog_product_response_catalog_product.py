...
class DeleteCatalogProductResponseCatalogProduct(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "disableDescription", "externalId", "id", "createdAt", "updatedAt", "deletedAt"]
