...
class ListInvoicesResponse(BaseModel):
    ...
    """ # noqa: E501
    invoices: List[GetInvoiceResponseInvoice]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoices": [GetInvoiceResponseInvoice.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None,
            "total": obj.get("total"),
