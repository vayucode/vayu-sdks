...
class ListCustomFieldsResponse(BaseModel):
    ...
    """ # noqa: E501
    custom_fields: List[CreateCustomFieldResponseCustomField] = Field(alias="customFields")
    ...
    __properties: ClassVar[List[str]] = ["customFields", "total", "hasMore", "nextCursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customFields": [CreateCustomFieldResponseCustomField.from_dict(_item) for _item in obj["customFields"]] if obj.get("customFields") is not None else None,
            "total": obj.get("total"),
