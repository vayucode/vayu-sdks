...
class V2DeleteEventsByRefsResponse(BaseModel):
    """
    V2DeleteEventsByRefsResponse
    """ # noqa: E501
    events: List[DeleteEventsByRefsResponseEventsInner] = Field(description="The events that were deleted")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [DeleteEventsByRefsResponseEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
